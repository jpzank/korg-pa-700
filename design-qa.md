...
- `Adicionar músicas` abre a bandeja, move o foco para a busca e deixa explícito o repertório de destino.
- A bandeja apresenta `Todas as músicas` e os repertórios disponíveis no dropdown `Mostrar`.
- O filtro de repertório e a busca combinada reduziram o resultado imediatamente.
